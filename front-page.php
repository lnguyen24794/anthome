                ...
                <div class="col-lg-9">
                    ...
                    if ( anthome_is_woocommerce_activated() ) {
                        ...
                        $product_args = array(
                            ...
                            'posts_per_page' => 12, // Limit the number of products to 12
                        );
                                            ...
                                            <a href="<?php the_permalink(); ?>" class="text-decoration-none">
                                                <div class="card-img-wrapper position-relative overflow-hidden">
                                                    ...
                                                    <div class="product-name-overlay position-absolute bottom-0 start-0 end-0 p-3">
                                                        ...
                                                        <h4 class="product-name-overlay-text text-white text-center text-capitalize fw-bold mb-0 position-relative">
